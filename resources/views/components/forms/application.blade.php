    ...
    <form method="post" action="{{ route('user.application.update') }}"  >
        ...
        <div id="mailing_instructions">
            <div class="instructions text-center">
                ...
                <div class="font-bold flex flex-col text-center">
                    <div>Your check should be made out to: <b>Roxbury High School</b> and sent to:</div>
        ...
        <div class="flex flex-row flex-wrap">
            <div style="width: 50%; text-align: center;">
                ...
                <div>
                    @php($acceptApplications = (@now() > date('2025-09-30 23:59:59')))
                    ...
                    @else
                        <div>
                            Applications will be accepted starting Wednesday, <span style="white-space: nowrap">October 1, 2025</span>.
                        </div>
                    @endif
                </div>
            </div>
