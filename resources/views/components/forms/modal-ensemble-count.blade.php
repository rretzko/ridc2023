...
<div class="relative z-10 top-0 @if(! $this->showEnsembleCountModal) hidden @endif" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    ShowEnsembleCountModal: {{ $this->showEnsembleCountModal }}
  <!--
